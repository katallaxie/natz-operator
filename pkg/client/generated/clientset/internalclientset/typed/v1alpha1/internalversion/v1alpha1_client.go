...
// NatzClient is used to interact with features provided by the natz.katallaxie.dev group.
...
func setConfigDefaults(config *rest.Config) error {
	...
	if config.GroupVersion == nil || config.GroupVersion.Group != scheme.Scheme.PrioritizedVersionsForGroup("natz.katallaxie.dev")[0].Group {
		gv := scheme.Scheme.PrioritizedVersionsForGroup("natz.katallaxie.dev")[0]
